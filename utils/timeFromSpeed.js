...
export function getTimeBasedOnSpeedMessage(speed, speedUnit, distance, distanceUnit, interfaceUnit) {
    ...
    return buildOutputString(roundingWithDecimals(speed), speedUnit, interfaceUnit, roundingWithDecimals(distance), distanceUnit, time.toString(), inputtedDistance, inputtedSpeed);
}
